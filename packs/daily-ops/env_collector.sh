...
STALE_STATS_WARN=50
# tbs_manager.sh: shrink CANDIDATE threshold, and the extent count above which a
# segment is reported as a fact about allocation history.
TS_SHRINK_FREE_PCT=30
TS_FRAG_EXTENTS=1000

# --- History table (opt-in; same table as the Health Check pack uses) --------
